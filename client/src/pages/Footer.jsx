...
const Footer = () => {
  return (
    <>
      ...
      <footer
        className="flex flex-col items-center justify-center w-full py-16 px-4 text-white/80"
        style={{
          background:
            "radial-gradient(circle at 70% 30%, rgba(155, 135, 245, 0.15) 0%, rgba(13, 10, 25, 0) 60%), linear-gradient(135deg, #0a0613 0%, #150d27 100%)",
        }}
      >
        <div className="max-w-[1250px] w-full flex flex-col items-center justify-center bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl shadow-lg p-8 text-center">
          {/* Logo */}
          <svg
            width="157"
            height="40"
          ...
          <div className="flex items-center gap-5 mt-6">
            {[
              "M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z", // FB
              "M17 2H7a5 5 0 0 0-5 5v10a5 5 0 0 0 5 5h10a5 5 0 0 0 5-5V7a5 5 0 0 0-5-5", // IG box
              "M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-4 0v7h-4v-7a6 6 0 0 1 6-6M6 9H2v12h4zM4 6a2 2 0 1 0 0-4 2 2 0 0 0 0 4", // LinkedIn
              "M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2", // Twitter
              "M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.4 5.4 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65S8.93 17.38 9 18v4", // GitHub
            ].map((d, i) => (
              <a
                href="#"
                key={i}
                className="hover:-translate-y-1 transition-all duration-300 bg-white/10 p-2 rounded-xl border border-white/20 backdrop-blur-sm hover:bg-white/20"
              >
                <svg
                  width="24"
                  height="24"
